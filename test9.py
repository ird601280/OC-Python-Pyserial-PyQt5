...
class MainWindow(QMainWindow):
    ...
    def initUI(self):
        ...
        self.btnSaveLeft = QPushButton("Save Settings")
        self.btnSaveLeft.setStyleSheet("""
            background-color: #4CAF50;
            color: white;
            font-weight: bold;
        """)
        leftLayout.addWidget(self.btnSaveLeft)
        ...
        self.btnSaveWave = QPushButton("Save Settings")
        self.btnSaveWave.setStyleSheet("""
            background-color: #2196F3;
            color: white;
            font-weight: bold;
        """)
        centerLayout.addWidget(self.btnSaveWave)
        ...
        self.btnSaveSerial = QPushButton("Save Settings")
        self.btnSaveSerial.setStyleSheet("""
            background-color: #FF9800;
            color: white;
            font-weight: bold;
        """)
        rightLayout.addWidget(self.btnSaveSerial)
        ...
        # Stretch so graph expands properly
